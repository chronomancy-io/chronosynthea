...
pub const MARITAL_STATUSES: &[(&str, f32)] = &[("M", 0.50), ("S", 0.35), ("D", 0.10), ("W", 0.05)];
...
pub const PROVIDER_CATALOG: &[(&str, &str, &str, &str, &str)] = &[
    ...
    (
        ...
        "p1000003-0000-0000-0000-000000000003",
        "Dr. Patel",
        "Boston",
    ),
    (
        ...
        "p1000004-0000-0000-0000-000000000004",
        "Dr. Murphy",
        "Worcester",
    ),
    (
        ...
        "p1000005-0000-0000-0000-000000000005",
        "Dr. Goldberg",
        "Cambridge",
    ),
    (
        ...
        "p1000006-0000-0000-0000-000000000006",
        "Dr. Nguyen",
        "Lowell",
    ),
    (
        ...
        "Lawrence Memorial",
        "p1000007-0000-0000-0000-000000000007",
        "Dr. Reyes",
        "Lawrence",
    ),
    (
        ...
        "p1000008-0000-0000-0000-000000000008",
        "Dr. Khan",
        "Newton",
    ),
    (
        ...
        "p1000009-0000-0000-0000-000000000009",
        "Dr. Sullivan",
        "Quincy",
    ),
    (
        ...
        "Brockton Hospital",
        "p1000010-0000-0000-0000-000000000010",
        "Dr. Russo",
        "Brockton",
    ),
    (
        ...
        "p1000011-0000-0000-0000-000000000011",
        "Dr. Bauer",
        "Springfield",
    ),
    (
        "a1b2c3d4-0012-0000-0000-000000000012",
        "Chicopee Family Care",
        "p1000012-0000-0000-0000-000000000012",
        "Dr. Park",
        "Chicopee",
    ),
    (
        "a1b2c3d4-0013-0000-0000-000000000013",
        "New Bedford Medical Group",
        "p1000013-0000-0000-0000-000000000013",
        "Dr. Olsen",
        "New Bedford",
    ),
    (
        ...
        "Fall River Medical",
        "p1000014-0000-0000-0000-000000000014",
        "Dr. Vargas",
        "Fall River",
    ),
    (
        ...
        "p1000015-0000-0000-0000-000000000015",
        "Dr. Carter",
        "Framingham",
    ),
    (
        ...
        "p1000016-0000-0000-0000-000000000016",
        "Dr. Iqbal",
        "Methuen",
    ),
    (
        ...
        "Salem Hospital",
        "p1000017-0000-0000-0000-000000000017",
        "Dr. Faulkner",
        "Lynn",
    ),
    (
        ...
        "p1000018-0000-0000-0000-000000000018",
        "Dr. Schwartz",
        "Cambridge",
    ),
    (
        ...
        "p1000019-0000-0000-0000-000000000019",
        "Dr. Iyer",
        "Boston",
    ),
    (
        ...
        "p1000020-0000-0000-0000-000000000020",
        "Dr. Halloran",
        "Weymouth",
    ),
    (
        ...
        "Lahey Hospital",
        "p1000021-0000-0000-0000-000000000021",
        "Dr. Robinson",
        "Cambridge",
    ),
    (
        ...
        "p1000022-0000-0000-0000-000000000022",
        "Dr. Costello",
        "Boston",
    ),
    (
        ...
        "p1000023-0000-0000-0000-000000000023",
        "Dr. Hammond",
        "Boston",
    ),
    (
        ...
        "p1000024-0000-0000-0000-000000000024",
        "Dr. Ashford",
        "Boston",
    ),
    (
        ...
        "p1000025-0000-0000-0000-000000000025",
        "Dr. Larsen",
        "Springfield",
    ),
    (
        ...
        "p1000026-0000-0000-0000-000000000026",
        "Dr. Wallace",
        "Springfield",
    ),
    (
        ...
        "p1000027-0000-0000-0000-000000000027",
        "Dr. Talbot",
        "Framingham",
    ),
    (
        ...
        "Heywood Hospital",
        "p1000028-0000-0000-0000-000000000028",
        "Dr. Doyle",
        "Worcester",
    ),
    (
        ...
        "p1000029-0000-0000-0000-000000000029",
        "Dr. Marsh",
        "Haverhill",
    ),
    (
        ...
        "Beverly Hospital",
        "p1000030-0000-0000-0000-000000000030",
        "Dr. Conrad",
        "Peabody",
    ),
    (
        ...
        "Cape Cod Hospital",
        "p1000031-0000-0000-0000-000000000031",
        "Dr. Whitcombe",
        "Barnstable",
    ),
    (
        ...
        "Falmouth Hospital",
        "p1000032-0000-0000-0000-000000000032",
        "Dr. Sanchez",
        "Barnstable",
    ),
];
...
pub const LAB_VALUES: &[(&str, &str, f32, f32, f32, f32, &str)] = &[
    ...
    (
        "2085-9",
        "Cholesterol in HDL [Mass/volume]",
        55.0,
        15.0,
        20.0,
        100.0,
    ...
    (
        "2028-9",
        "Carbon dioxide, total [Moles/volume] in Serum",
        27.0,
        3.0,
        18.0,
        35.0,
...
pub const PAYER_UUIDS: &[(&str, &str, &str)] = &[
    ...
    (
        "70c8a0e8-2a99-3b3f-b6e1-3a9a0e0f5b8c",
        "BCBS_MA",
    ...
    (
        "85cbcfa9-5c99-3b3f-b6e1-3a9a0e0f5b8f",
        "UNITED",
        "UnitedHealthcare",
    ),
];
